 ...
 */
package net.moopa.calling.client.demo;

import net.moopa.calling.client.ClientFactory;
import net.moopa.calling.services.services.HelloService;
import net.moopa.calling.services.servicesImpl.HelloServiceImpl;
