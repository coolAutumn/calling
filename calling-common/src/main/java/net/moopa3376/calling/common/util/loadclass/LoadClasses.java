 ...
 */
package net.moopa3376.calling.common.util.loadclass;
...
public class LoadClasses {
    private static Logger logger = LoggerFactory.getLogger(Constant.LOADCLASS_LOGGERNAME);
        ...
        if(directory.exists() && directory.isDirectory()){
            ...
            for(File file : files){
                if(file.getName().endsWith(".class")){
                    list.add(classLoader.loadClass(pkgName+"."+file.getName()));
