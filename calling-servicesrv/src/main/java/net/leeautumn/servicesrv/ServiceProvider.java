...
public abstract class ServiceProvider {
    ...
    public abstract void invoke(ChannelHandlerContext ctx, ProtocolMessage protocolMessage);
    ...
    public void setProtocolSerializer(ProtocolSerializer protocolSerializer) {
